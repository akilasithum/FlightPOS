...
public class Constants {
    ...
    public static final String SHARED_PREFERENCE_USER_DETAILS = "userDetails";
    public static final String SHARED_PREFERENCE_KEEP_SAME_FLIGHT = "keepSameFlight";
    public static final String SHARED_PREFERENCE_BASE_STATION = "baseStation";

    public static final String PRINTER_LOGO_LOCATION = "/res/drawable/print_bg.png";
