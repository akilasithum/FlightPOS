...
import com.pos.airport.objects.OrderDetails;
...
public class PrintTransactionActivity extends AppCompatActivity {
    ...
    private void showOrdersInTable(List<OrderDetails> orderDetails){
        ...
        for(final OrderDetails detail : orderDetails){
            ...
            printBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new AlertDialog.Builder(PrintTransactionActivity.this)
        ...
        if(isSuccess){
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            PrintJob.printVoidOrderReceipt(PrintTransactionActivity.this,orderId,details.getSeatNo(),items,handler.getPaymentMethodsMapFromOrderNumber(orderId)
    ...
    private void voidItems(){
        if (voidItemsList != null && !voidItemsList.isEmpty()) {
            ...
            if(amountToRefund != refundAmount){
                Toast.makeText(PrintTransactionActivity.this, "Amount to refund should be equal to cancel items total.", Toast.LENGTH_SHORT).show();
                return;
            }
            new AlertDialog.Builder(PrintTransactionActivity.this)
                    .setTitle("Void Items")
            ...
            Toast.makeText(PrintTransactionActivity.this, "No items selected.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void voidItemsFromList(){
        ...
        Toast.makeText(PrintTransactionActivity.this, "Void items successfully.", Toast.LENGTH_SHORT).show();
    }

    private void printCustomerCopy(List<SoldItem> refundItems,OrderDetails details){

        boolean isSuccess = PrintJob.printVoidOrderByReceipt(PrintTransactionActivity.this,orderIdStr,details.getSeatNo(),refundItems,true);
        if(isSuccess) {
